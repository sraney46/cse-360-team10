 ...
 * WHen those buttons
 * are pressed, an alert pops up to tell the user that the function associated
 * with the button has
 * not been implemented. Also, be aware that What has been implemented may not
 * work the way the
...
public class ControllerAdminHome {
  ...
  */
   ...
   * establish
   * an account and a specific role.
   * </p>
   */
   ...
   * for any of
   * the users currently in the system. This is done by invoking the
   * AddRemoveRoles Page. There
   ...
   * before it is
   * used to reduce errors. The code currently only checks to see that the email
   * address is not
   * empty. In the future, a syntactic check must be performed and maybe there is
   * a way to check
   * if a properly email address is active.
   * </p>
   * 
   * @param emailAddress This String holds what is expected to be an email address
   *
   * @return This returns TRUE is the email is incorrect and FALSE if it is
   *         correct
   */
