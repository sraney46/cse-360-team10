...
/*******
 * <p>
 * Title: ControllerNewAccount Class.
 * </p>
 * 
 * <p>
 * Description: The Java/FX-based New Account Page. This class provides the
 * controller actions
 * to allow the user to establish a new account after responding to an
 * invitation and the use of a
 * one time code.
 * 
 * The controller deals with the user pressing the "User Step" button widget
 * being click. If also
...
public class ControllerNewAccount {
  ...
  */
   ...
   * Setup
   * button. This method checks the input fields to see that they are valid. If
   * so, it then
  ...
  protected static void doCreateUser() {
    ...
    String checkUser = ModelFirstAdmin.checkForValidUserName(username);
