 ...
 * home
 * page when the user has only one role. This is not actually a GUI page... it
 * just dispatches
 * to an actual GUI page for the specified role.
 * 
 * WHen a user has more than one role, a different
 * class, GUIMultipleRoleHomePage, asks the user which of their roles do they
 * want to use,
 * and then it dispatches the user to that role's home page.
 * </p>
 * 
 * <p>
...
public class GUISingleRoleDispatch {
  ...
  /**********
   * <p>
   * Method: doSingleRoleDispatch(Stage ps, User user)
   * </p>
   * 
   * <p>
   * Description: This method is called after a GUI page has already been
   * established and
   * it is being display with potentially new contents for the various GUI
   * elements.
   * </p>
   * 
